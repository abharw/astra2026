...
namespace SpatialAssembly {
 ...
 public class SavedAssemblies:MonoBehaviour {
  ...
  public bool Delete(AssemblyVisual visual){
   ...
   deleted.Add(id);live.RemoveAll(v=>!v||v.ObjectId==id);var root=visual.transform.parent.gameObject;root.SetActive(false);_ = EraseRemovedAnchor(root);return true;
  }
