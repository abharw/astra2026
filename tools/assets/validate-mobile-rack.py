...
blender -b --factory-startup --python tools/assets/validate-mobile-rack.py -- source.usdz mobile.usdz
...
if __name__ == "__main__":
    ...
    source_path = Path(args[0]) if args else root / ".local/asset-source/datacenter-rack/models/lazy/rack-exterior.usdz"
    output_path = Path(args[1]) if len(args) > 1 else root / ".local/processed-assets/rack-exterior-mobile.usdz"
    try:
