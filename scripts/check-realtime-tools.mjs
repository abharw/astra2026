...
// Run: node scripts/check-realtime-tools.mjs
...
const WebSocket = require("../services/session/node_modules/ws");
const root = new URL("../", import.meta.url);
const output = new URL("evidence/realtime-tools-smoke.json", root);
...
async function run() {
  let savedConfig = {};
  try { savedConfig = JSON.parse(await readFile(new URL("runtime/dev-session.json", root), "utf8")); }
