...
p=argparse.ArgumentParser();p.add_argument('action');p.add_argument('--x',type=float);p.add_argument('--y',type=float);p.add_argument('--operation');p.add_argument('--amount',type=float);p.add_argument('--part');p.add_argument('--output');p.add_argument('--from-x',dest='fromX',type=float);p.add_argument('--from-y',dest='fromY',type=float);p.add_argument('--question');p.add_argument('--frame-id',dest='frameId');p.add_argument('--object-id',dest='objectId');a=p.parse_args()
