...
public static class BuildQuest {
 ...
 static void CreateVoiceIndicator(Transform head,RealtimeAudio audio,BridgeConnection bridge){
  ...
  var label=Text(go.transform,"Voice state",new Vector2(15,0),new Vector2(106,30),16,"Hold B · off");label.alignment=TextAnchor.MiddleLeft;label.raycastTarget=false;
