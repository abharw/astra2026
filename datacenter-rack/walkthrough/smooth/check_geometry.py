...
check={'schema':'maze-geometry-check/v1','camera_poses_checked':len(poses),'minimum_camera_capsule_clearance_m':clear-.25,'camera_radius_m':.25,'poses_outside_floor':outside,'rack_aabb_overlaps':collisions,'racks_intersecting_walls':wall_hits,'turn_sequence':['left','right','left'],'authored_route_length_m':d['motion']['path_length_m'],'status':'pass' if clear>.25 and not outside and not collisions and not wall_hits else 'fail','limits':'Authored geometric bounds check; generated video requires separate review.'}
