...
python3 scripts/dev-session.py doctor --url https://<TUNNEL_HOST>
python3 scripts/dev-session.py launch --device <DEVICE_ID> --url https://<TUNNEL_HOST>
```
